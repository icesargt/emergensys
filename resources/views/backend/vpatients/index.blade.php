								...
								<tr>
									...
									<td>
										<form class="" action="{{route('patient_lists.destroy', $patient->id_patient )}}" method="post">
			                                ...
			                                <a href="{{route('patient_lists.edit', $patient->id_patient )}}" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon glyphicon-edit" aria-hidden="true"></span> Editar</a>

			                                <a href="{{route('patient_lists.show', $patient->id_patient )}}" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-send" aria-hidden="true"></span> Enviar SMS</a>
